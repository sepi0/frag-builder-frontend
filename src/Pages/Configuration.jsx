...
export default class Configuration extends React.Component {
  ...
  render() {
    return (
      <div>
        <Navbar />
        <div className="flex flex-row justify-center h-360p bg-white shadow">
          <div className="w-720p h-360p items-center">
            <h1 className="text-5xl sm:text-6xl text-center text-carbon-900 font-archivo h-64">
              ./KONFIGURÁTOR
            </h1>
          </div>
        </div>
        <div id="vyhladavanie" className="flex flex-col self-center">
          ...
          <h1 className="text-3xl text-center text-carbon-500 font-archivo">
          ...
          <p className=" font-bold font-mulish text-center">
            Ak chceš, môžeš si zvoliť viacero komponentov a na konci
            konfigurácie si ich povyhadzuješ z košíka..
          </p>
